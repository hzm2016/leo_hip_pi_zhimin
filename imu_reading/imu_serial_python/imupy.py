...
imu_buffer = np.memmap("../data/imu_bluetooth.npy", dtype='float32', mode='r+', shape=(4,))  
...
def Cmd_RxUnpack(buf, DLen):  
    ...
    global angle_x, angle_y, vel_x, vel_y, imu_buffer  
    ...
    if buf[0] == 0x11:  
        ...
        if ((ctl & 0x0040) != 0):
            ...
            imu_buffer[0] = angle_x 
            imu_buffer[1] = angle_y  
